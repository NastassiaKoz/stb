...
электронных документов и СОК. Стандарт основан на документе [[1]](#99.1).
...
инкапсулировать в простые объекты MIME [[2]](#99.2), заголовки `Content-Type`
...
Требования к сторонам протоколов определяются в разделе [6](#6), форматы
запроса и ответа – в разделе [7](#7).

# 6 <a name="6"></a>Требования
...
# 7 <a name="7"></a> Форматы

## 7.1 <a name="7.1"></a>Вспомогательные типы данных

### 7.1.1 <a name="7.1.1"></a>Тип `DigestInfo`
...
### 7.1.2 <a name="7.1.2"></a>Тип `DVCSTime`
...
### 7.1.3 <a name="7.1.3"></a>Тип `PKIStatusInfo`
...
### 7.1.4 <a name="7.1.4"></a>Тип `PathProcInput`
...
### 7.1.5 <a name="7.1.5"></a>Тип `CertEtcToken`
...
в определении типа только  для сохранения совместимости с [[1]](#99.1).

### 7.1.6 <a name="7.1.6"></a>Тип `TargetEtcChain`
...
### 7.1.7 <a name="7.1.7"></a>Тип `DVCSRequestInformation`
...
определении типа `ServiceType` объясняются в [5.2](#5.2).
...
### 7.1.9 <a name="7.1.9"></a>Тип `DVCSCertInfo`
...
### 7.1.10 <a name="7.1.10"></a>Тип `DVCSErrorNotice`
...
## 7.2 <a name="7.2"></a>Формат запроса
...
## 7.3 <a name="7.3"></a>Формат ответа
...
## 7.4 <a name="7.4"></a>Аттестат как атрибут
