...
### 5 [Общие положения](#5)
### 6 [Атрибутные сертификаты](#6)
### 7 [Отношения между центрами](#7)
### 8 [Модели инфраструктуры управления привилегиями](#8)
### 9 [Расширения сертификатов, связанные с управлением привилегиями](#9)
### 10 [Процедуры обработки маршрутов атрибутных сертификатов](#10)
### 11 [Схема директории инфраструктуры управления привилегиями](#11)
### [Приложение А (обязательное) Модуль АСН.1](#91)
### [Приложение Б (справочное) Пояснения к расширениям синтаксиса АСН.1](#92)
### [Приложение В (справочное) Пример атрибутного сертификата](#93) 
### [Библиография](#99)
...
# 6 <a name="6"></a> Атрибутные сертификаты

## 6.1 <a name="6.1"></a> Формат атрибутных сертификатов
...
# 7 <a name="7"></a> Отношения между центрами
...
# 8 <a name="8"></a>Модели инфраструктуры управления привилегиями
...
# 9 <a name="9"></a> Расширения сертификатов, связанные с управлением привилегиями
...
кодировке АСН.1, которое задается согласно [3]. 
...
# 10 <a name="10"></a> Процедуры обработки маршрутов атрибутных сертификатов
...
# 11 <a name="11"></a> Схема директории инфраструктуры управления привилегиями
...
# <a name="92"></a>Приложение Б (справочное)
...
# <a name="93"></a>Приложение В (справочное)
