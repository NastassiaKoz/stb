...
### [10 Формат XAdES](#10)
### [11 Формат PADES](#11)
### [Приложение А (рекомендуемое) Расширенные профили](#91)
### [Библиография](#99)
...
символов см. [[19]](#99.19);

MIME — multipurpose Internet mail extensions (многоцелевые расширения 
интернет-почты, см. [[16]](#99.16); 

PAdES — РЭЦП для PDF;

PDF — portable data format (переносимый формат данных, см. [[18]](#99.18);

URI — uniform resource identifier (унифицированный идентификатор ресурса, 
см. [[1]](#99.1); 

URN — uniform resource name (унифицированное имя ресурса, см. [[20]](#99.20); 

XAdES — РЭЦП для XML;

XML — extensible markup language (расширяемый язык разметки, см. [[2]](#99.2);

XML-DSig — XML digital signature (ЭЦП для XML, см. [[5]](#99.5);

XPointer — XML pointer (указатель XML, см. [[3]](#99.3).
...
[[6]-[15]], разработанных Европейским институтом 
...
В разделе [6](#6) определяются возможные атрибуты РЭЦП: 
...
профилями атрибутов. В разделе [7](#7) определяются 4 таких профиля. 
...
В разделе [8](#8) определяются процессы выработки и проверки РЭЦП 
...
Подпись XAdES описывается на языке XML, определенном в [[2]](#99.2). 
...
документы формата PDF, определенного в [[18]](#99.18). 
...
## 6.1 <a name="6.1"></a>Общие положения
...
## 6.2 <a name="6.2"></a>Базовые атрибуты РЭЦП

### 6.2.1 <a name="6.2.1"></a>Атрибут `ContentType`
<!--- 5.7.1; 5.1.1 -->
...
### 6.2.2 <a name="6.2.2"></a>Атрибут `MessageDigest`
<!--- 5.7.2; 5.1.2 -->
...
### 6.2.3 <a name="6.2.3"></a>Атрибут `SigningTime`
<!--- 5.9.1; 5.2.1 -->
...
### 6.2.4 <a name="6.2.4"></a>Атрибут `SigningCertificate`
<!--- 5.7.3; 5.2.2 -->
...
### 6.2.5 <a name="6.2.5"></a>Атрибут `CommitmentTypeIndication`
<!--- 5.11.1; 5.2.3 -->
...
### 6.2.6 <a name="6.2.6"></a>Атрибут `ContentHints`
<!--- 5.10.3; 5.2.4.1 -->
...
### 6.2.7 <a name="6.2.7"></a>Атрибут `MimeType`
<!--- ; 5.2.4.2 -->
...
### 6.2.8 <a name="6.2.8"></a>Атрибут `DataObjectFormat`
<!--- ; 5.2.4 XAdES -->
...
### 6.2.11 <a name="6.2.11"></a>Атрибут `Countersignature`
<!--- 5.9.2; 5.2.7 -->
...
### 6.2.12 <a name="6.2.12"></a>Атрибут `ContentTimeStamp`
<!--- 5.11.4; 5.2.8 -->
...
### 6.2.13 <a name="6.2.13"></a>Атрибут `AllDataObjectsTimeStamp`
<!--- ; 5.2.8.1 XAdES -->
...
### 6.2.14 <a name="6.2.14"></a>Атрибут `IndividualDataObjectsTimeStamp`
<!--- ; 5.2.8.2 XAdES -->
...
### 6.2.15 <a name="6.2.15"></a>Атрибут `SignaturePolicyIdentifier`
<!--- 5.8.1; 5.2.9 -->
...
### 6.2.16 <a name="6.2.16"></a>Атрибут `SignaturePolicyStore`
<!--- ; 5.2.10 -->
...
### 6.2.17 <a name="6.2.17"></a>Атрибут `ContentReference`
<!--- 5.10.1; 5.2.11 -->
...
### 6.2.18 <a name="6.2.18"></a>Атрибут `ContentIdentifier`
<!--- 5.10.2; 5.2.12 -->
...
## 6.3 <a name="6.3"></a>Атрибут штампа времени подписи

### 6.3.1 <a name="6.3.1"></a>Атрибут `SignatureTimeStamp`
<!--- 6.1; 5.3 -->
...
## 6.4 <a name="6.4"></a>Атрибуты для указания проверочных данных

<!--- Атрибуты проверки цепочки сертификатов-->

### 6.4.1 <a name="6.4.1"></a>Атрибут `CompleteCertificateReferences`
<!--- 6.2.1; A.1.1.1 -->
...
### 6.4.2 <a name="6.4.2"></a>Атрибут `CertificateValues`
<!--- 6.3.3; A.1.1.2 -->
...
### 6.4.3 <a name="6.4.3"></a>Атрибут `CompleteRevocationReferences`
<!--- 6.2.2; A.1.2.1 -->
...
### 6.4.4 <a name="6.4.4"></a>Атрибут `RevocationValues`
<!--- 6.3.4; A.1.2.2 -->
...
### 6.4.5 <a name="6.4.5"></a>Атрибут `AttributeCertificateReferences`
<!--- 6.2.3; A.1.3 -->
...
### 6.4.6 <a name="6.4.6"></a>Атрибут `AttributeCertificateValues`
<!--- ; XAdES 5.4.3 -->
...
### 6.4.7 <a name="6.4.7"></a>Атрибут `AttributeRevocationReferences`
<!--- 6.2.4; A.1.4 -->
...
### 6.4.8 <a name="6.4.8"></a>Атрибут `AttributeRevocationValues`
<!--- ; XAdES 5.4.4 -->
...
### 6.4.9 <a name="6.4.9"></a>Атрибут `RefsOnlyTimeStamp`
<!--- 6.3.6; A.1.5.1 -->
...
### 6.4.10 <a name="6.4.10"></a>Атрибут `SigAndRefsTimeStamp`
<!--- 6.3.5; A.1.5.2 -->
...
## 6.5 <a name="6.5"></a>Атрибуты архивной проверки

### 6.5.1 <a name="6.5.1"></a>Атрибут `TimeStampValidationData`
<!--- ; 5.5.2 -->
...
### 6.5.2 <a name="6.5.2"></a>Атрибут `ArchiveTimeStamp`
<!--- ; 5.5.3 -->
...
### 6.5.3 <a name="6.5.3"></a>Атрибут `RenewedDigests`
<!--- ; XAdES 5.5.3 -->
...
# 7 <a name="7"></a>Профили

## 7.1 <a name="7.1"></a>Общие положения
...
частях раздела [10](#10).

Остальные требования остаются прежними.

## 7.5 <a name="7.5"></a>Профиль B-LTA
...
# 8 <a name="8"></a>Процессы

## 8.1 <a name="8.1"></a>Выработка подписи

### 8.1.1 <a name="8.1.1"></a>Соглашения
...
### 8.1.2 <a name="8.1.2"></a>Выработка подписи профиля B-B
...
использоваться программа проверки подписи, описанная в [8.2](#8.2). Если
...
### 8.1.3 <a name="8.1.3"></a>Выработка подписи профиля B-T
...
### 8.1.4 <a name="8.1.4"></a>Выработка подписи профиля B-LT
...
### 8.1.5 <a name="8.1.5"></a>Выработка подписи профиля B-LTA
...
## 8.2 <a name="8.2"></a>Проверка подписи

### 8.2.1 <a name="8.2.1"></a>Cоглашения
...
### 8.2.2 <a name="8.2.2"></a>Вспомогательные алгоритмы

#### 8.2.2.1 <a name="8.2.2.1"></a>Проверка актуальности аттестата отзыва
...
#### 8.2.2.2 <a name="8.2.2.2"></a>Проверка сертификата
...
аттестатов отзыва. Использовать для этого алгоритм [8.2.2.1](#8.2.2.1).
...
#### 8.2.2.3 <a name="8.2.2.3"></a>Проверка штампа времени
...
[8.2.3](#8.2.3). Переадресовать алгоритму собственные входные данные, в
том числе сертификат службы штампов времени в качестве сертификата подписанта.

**Шаг 2.** Если алгоритм [8.2.3](#8.2.3) завершен с вердиктом `FAILED` или
...
#### 8.2.2.4 <a name="8.2.2.4"></a>Сдвиг времени проверки
...
- если аттестат не определяет отзыв сертификата, то проверить актуальность
  аттестата с помощью алгоритма [8.2.2.1](#8.2.2.1) на момент 
...
#### 8.2.2.5 <a name="8.2.2.5"></a>Проверка сертификата в прошлом
...
**Шаг 3.** Применить алгоритм [8.2.2.4](#8.2.2.4). Если алгоритм возвращает
...
#### 8.2.2.6 <a name="8.2.2.6"></a>Извлечение доказательств существования
...
#### 8.2.2.7 <a name="8.2.2.7"></a>Повторная проверка подписи
...
**Шаг 1.** Выполнить алгоритм [8.2.2.5](#8.2.2.5), переадресовав ему
...
### 8.2.3 <a name="8.2.3"></a>Проверка подписи профиля B-B
...
[8.2.2.2](#8.2.2.2). Передать алгоритму входные данные и данные, полученные
...
проверки штампа использовать алгоритм [8.2.2.3](#8.2.2.3);
...
использовать алгоритм [8.2.2.3](#8.2.2.3);
...
ограничения, заданные в его описании (см. [6](#6)). При нарушении
...
штампа использовать алгоритм [8.2.2.3](#8.2.2.3).
...
### 8.2.4 <a name="8.2.4"></a>Проверка подписи профилей B-T и B-LT
...
[8.2.3](#8.2.3). Переадресовать алгоритму собственные входные данные.
...
вердикт и статус алгоритма [8.2.3](#8.2.3). 
...
б) проверить штамп с помощью алгоритма [8.2.2.3](#8.2.2.3). Если алгоритм
...
этого выполнить алгоритм [8.2.2.1](#8.2.2.1), использовав
...
**Шаг 7 (проверка дополнительных ограничений).**
Повторить шаг 7 алгоритма [8.2.3](#8.2.3) проверки подписи профиля B-B,
...
### 8.2.5 <a name="8.2.5"></a>Проверка подписи профиля B-LTA
...
[8.2.4](#8.2.4), переадресовав ему собственные входные данные.
...
алгоритма [8.2.4](#8.2.4); 

б) если алгоритм [8.2.4](#8.2.4) возвратил `PASSED` и политика проверки 
...
дополнительным выходом алгоритма [8.2.4](#8.2.4), выполненного на шаге 2.
...
а) проверить штамп с помощью алгоритма [8.2.2.3](#8.2.2.3);

б) если алгоритм [8.2.2.3](#8.2.2.3) возвращает `PASSED` и функция
...
существования. Использовать алгоритм [8.2.2.6](#8.2.2.6). Передать на вход
алгоритма текущий список доказательств. Возвращенный алгоритмом список добавить
к текущему;

в) если алгоритм [8.2.2.3](#8.2.2.3) возвращает вердикт `INDETERMINATE` с
...
[8.2.2.7](#8.2.2.7) повторной проверки подписи. Подать на вход алгоритма
следующие данные:
...
Если алгоритм [8.2.2.7](#8.2.2.7) возвращает `PASSED` и функция
хэширования, использованная в штампе, удовлетворяет криптографическим
ограничениям на момент выпуска штампа, то извлечь из штампа доказательства
существования. Использовать алгоритм [8.2.2.6](#8.2.2.6). Подать на вход
алгоритма текущий список доказательств. Возвращенный алгоритмом список добавить
к текущему;
...
Выполнить алгоритм [8.2.2.7](#8.2.2.7) повторной проверки подписи со
...
# 9 <a name="9"></a>Формат CAdES

## 9.1 <a name="9.1"></a>Общие положения
...
## 9.2 <a name="9.2"></a>Синтаксис базовых атрибутов РЭЦП

### 9.2.1 <a name="9.2.1"></a>Атрибут `ContentType`
<!--- 5.7.1; 5.1.1 -->
...
### 9.2.2 <a name="9.2.2"></a>Атрибут `MessageDigest`
<!--- 5.7.2; 5.1.2 -->
...
### 9.2.3 <a name="9.2.3"></a>Атрибут `SigningTime`
<!--- 5.9.1; 5.2.1 -->

Синтаксис и правила включения атрибута `SigningTime` определены в СТБ 34.101.23
(пункт 15.4).

### 9.2.4 <a name="9.2.4"></a>Атрибут `SigningCertificate`
<!--- 5.7.3; 5.2.2 -->
...
[[4]](#99.4)], ДОЛЖЕН применяться тип `SigningCertificate`, а
...
Тип `SigningCertificate` определен в [[17]](#99.17).
Тип `SigningCertificateV2` определен в [[21]](#99.21).
...
### 9.2.5 <a name="9.2.5"></a>Атрибут `CommitmentTypeIndication`
<!--- 5.11.1; 5.2.3 -->
...
### 9.2.6 <a name="9.2.6"></a>Атрибут `ContentHints`
<!--- 5.10.3; 5.2.4.1 -->
...
данных, определенного в соответствии с правилами документа [[16]](#99.16).
<!--- Пример структурированного содержимого и типов MIME см. в приложении Е. -->

### 9.2.7 <a name="9.2.7"></a>Атрибут `MimeType`
<!--- ; 5.2.4.2 -->
...
формироваться по правилам, определенным в [[16]](#99.16).
...
### 9.2.8 <a name="9.2.8"></a>Атрибут `SignerLocation`
<!--- 5.11.2; 5.2.5 -->
...
### 9.2.9 <a name="9.2.9"></a>Атрибут `SignerAttributes`
<!--- 5.11.3; 5.2.6.1 -->
...
### 9.2.10 <a name="9.2.10"></a>Атрибут `CounterSignature`
<!--- 5.9.2; 5.2.7 -->
...
### 9.2.11 <a name="9.2.11"></a>Атрибут `ContentTimeStamp`
<!--- 5.11.4; 5.2.8 -->
...
### 9.2.12 <a name="9.2.12"></a>Атрибут `SignaturePolicyIdentifier`
<!--- 5.8.1; 5.2.9 -->
...
### 9.2.13 <a name="9.2.13"></a>Атрибут `SignaturePolicyStore`
<!--- ; 5.2.10 -->
...
### 9.2.14 <a name="9.2.14"></a>Атрибут `ContentReference`
<!--- 5.10.1; 5.2.11 -->
...
### 9.2.15 <a name="9.2.15"></a>Атрибут `ContentIdentifier`
<!--- 5.10.2; 5.2.12 -->
...
## 9.3 <a name="9.3"></a>Синтаксис атрибута штампа времени

### 9.3.1 <a name="9.3.1"></a>Атрибут `SignatureTimeStamp`
<!--- 6.1.1; 5.3 -->
...
## 9.4 <a name="9.4"></a>Синтаксис атрибутов проверочных данных

### 9.4.1 <a name="9.4.1"></a>Атрибут `CompleteCertificateReferences`
<!--- 6.2.1; A.1.1.1 -->
...
### 9.4.2 <a name="9.4.2"></a>Атрибут `CertificateValues`
<!--- 6.3.3; A.1.1.2 -->
...
### 9.4.3 <a name="9.4.3"></a>Атрибут `CompleteRevocationReferences`
<!--- 6.2.2; A.1.2.1 -->
...
### 9.4.4 <a name="9.4.4"></a>Атрибут `RevocationValues`
<!--- 6.3.4; A.1.2.1 -->
...
### 9.4.5 <a name="9.4.5"></a>Атрибут `AttributeCertificateReferences`
<!--- 6.2.3; A.1.3 -->
...
### 9.4.6 <a name="9.4.6"></a>Атрибут `AttributeCertificateValues`
<!--- ; XAdES 5.4.3 -->
...
### 9.4.7 <a name="9.4.7"></a>Атрибут `AttributeRevocationReferences`
<!--- 6.2.4; A.1.4 -->
...
### 9.4.8 <a name="9.4.8"></a>Атрибут `AttributeRevocationValues`
<!--- ; XAdES 5.4.3 -->
...
### 9.4.9 <a name="9.4.9"></a>Атрибут `RefsOnlyTimeStamp`
<!--- 6.3.6; A.1.5.1 -->
...
### 9.4.10 <a name="9.4.10"></a>Атрибут `SigAndRefsTimeStamp`
<!--- 6.3.5; A.1.5.2 -->
...
## 9.5 <a name="9.5"></a>Синтаксис атрибутов архивных проверочных данных


### 9.5.1 <a name="9.5.1"></a>Атрибут `TimeStampValidationData`
<!--- ; 5.5.2 -->
...
### 9.5.2 <a name="9.5.2"></a>Атрибут `ArchiveTimeStamp`
<!--- ; 5.5.3 -->
...
# 10 <a name="10"></a>Формат XAdES

## 10.1 <a name="10.1"></a>Общие положения

Язык XML, определенный в базовой спецификации [[2]](#99.2) и других
...
Правила подписания XML-документов определены в [[5]](#99.5) и
...
либо непосредственно в XML-DSig, либо в [10.5](#10.5) – [10.8](#10.8).
Атрибуты объединяются в XML-контейнеры, описанные в [10.2](#10.2). Контейнер
содержит XML-элементы, сам являясь XML-элементом. В [10.3](#10.3) определяются
...
## 10.2 <a name="10.2"></a>Контейнеры атрибутов

### 10.2.1 <a name="10.2.1"></a>Контейнер `QualifyingProperties`
...
### 10.2.2 <a name="10.2.2"></a>Контейнер `SignedProperties`
...
`SignedDataObjectProperties` описываются  в [10.2.4](#10.2.4), 
[10.2.5](#10.2.5).

РЭЦП НЕ ДОЛЖНА содержать пустой контейнер `SignedProperties`.

### 10.2.3 <a name="10.2.3"></a>Контейнер `UnsignedProperties`
...
`UnsignedDataObjectProperties` описываются  в [10.2.6](#10.2.6), 
[10.2.7](#10.2.7).

РЭЦП НЕ ДОЛЖНА содержать пустой контейнер `UnsignedProperties`. 

### 10.2.4 <a name="10.2.4"></a>Контейнер `SignedSignatureProperties`
...
Вложенные элементы-атрибуты описываются в [10.5](#10.5). 
...
### 10.2.5 <a name="10.2.5"></a>Контейнер `SignedDataObjectProperties`
...
### 10.2.6 <a name="10.2.6"></a>Контейнер `UnsignedSignatureProperties`
...
Вложенные элементы-атрибуты описываются в [10.5](#10.5) – [10.8](#10.8).
...
### 10.2.7 <a name="10.2.7"></a>Контейнер `UnsignedDataObjectProperties`
...
Вложенные элементы-атрибуты имеют тип `AnyType`, описанный в [10.4.1](#10.4.1).

РЭЦП НЕ ДОЛЖНА содержать пустой элемент `UnsignedDataObjectProperties`.

### 10.2.8 <a name="10.2.8"></a>Элемент `QualifyingPropertiesReference`
...
## 10.3 <a name="10.3"></a>Включение атрибутов в подпись

### 10.3.1 <a name="10.3.1"></a>Способы включения
...
### 10.3.2 <a name="10.3.2"></a>Подписанные атрибуты
...
## 10.4 <a name="10.4"></a>Вспомогательные типы данных

### 10.4.1 <a name="10.4.1"></a>Тип `AnyType`
...
### 10.4.2 <a name="10.4.2"></a>Тип `ObjectIdentifierType`
...
### 10.4.3 <a name="10.4.3"></a>Тип `EncapsulatedPKIDataType`
...
### 10.4.4 <a name="10.4.4"></a>Типы данных для управления штампами времени

#### 10.4.4.1 <a name="10.4.4.1"></a>Тип `GenericTimeStampType`
...
#### 10.4.4.2 <a name="10.4.4.2"></a>Тип `XAdESTimeStampType`
...
Штампы времени, определенные в [10.5.8.1](#10.5.8.1), [10.6](#10.6),
[10.7.5](#10.7.5), [10.7.6](#10.7.6) и [10.8.2](#10.8.2), неявно определяют
...
#### 10.4.4.3 <a name="10.4.4.3"></a>Тип `OtherTimeStampType`
...
## 10.5 <a name="10.5"></a>Базовые атрибуты

### 10.5.1 <a name="10.5.1"></a>Атрибут `SigningTime`
...
### 10.5.2 <a name="10.5.2"></a>Атрибут `SigningCertificate`
...
### 10.5.3 <a name="10.5.3"></a>Атрибут `CommitmentTypeIndication`
...
### 10.5.4 <a name="10.5.4"></a>Атрибут `DataObjectFormat`
...
### 10.5.5 <a name="10.5.5"></a>Атрибут `SignerLocation`
...
### 10.5.6 <a name="10.5.6"></a>Атрибут `SignerAttributes`
...
### 10.5.7 <a name="10.5.7"></a>Контрподписи

### 10.5.7.1 <a name="10.5.7.1"></a>Контрподпись с идентификатором
...
### 10.5.7.2 <a name="10.5.7.2"></a>Атрибут `CounterSignature`
...
### 10.5.8 <a name="10.5.8"></a>Штампы времени на объекты данных

#### 10.5.8.1 <a name="10.5.8.1"></a>Атрибут `AllDataObjectsTimeStamp`
...
применяться модель обработки ссылок, определенная в [[5]](#99.5).
После обработки (перед хэшированием) элементы ДОЛЖНЫ канонизироваться.

#### 10.5.8.2 <a name="10.5.8.2"></a>Атрибут `IndividualDataObjectsTimeStamp`
...
## 10.5.9 <a name="10.5.9"></a>Атрибут `SignaturePolicyIdentifier`

### 10.5.9.1 <a name="10.5.9.1"></a>Синтаксис
...
### 10.5.9.2 <a name="10.5.9.2"></a>Квалификаторы политики подписи
...
### 10.5.10 <a name="10.5.10"></a>Атрибут `SignaturePolicyStore`
...
### 10.6 <a name="10.6"></a>Атрибут `SignatureTimeStamp`
...
## 10.7 <a name="10.7"></a>Атрибуты-аттестаты

### 10.7.1 <a name="10.7.1"></a>Атрибут `CompleteCertificateReferences`
...
### 10.7.2 <a name="10.7.2"></a>Атрибут `CompleteRevocationReferences`
...
### 10.7.3 <a name="10.7.3"></a>Атрибут `AttributeCertificateReferences`
...
### 10.7.4 <a name="10.7.4"></a>Атрибут `AttributeRevocationReferences`
...
### 10.7.5 <a name="10.7.5"></a>Атрибут `SigAndRefsTimeStamp`
...
### 10.7.6 <a name="10.7.6"></a>Атрибут `RefsOnlyTimeStamp`
...
### 10.7.7 <a name="10.7.7"></a>Атрибут `CertificateValues`
...
### 10.7.8 <a name="10.7.8"></a>Атрибут `RevocationValues`
...
### 10.7.9 <a name="10.7.9"></a>Атрибут `AttributeCertificateValues`
...
### 10.7.10 <a name="10.7.10"></a>Атрибут `AttributeRevocationValues`  
...
## 10.8 <a name="10.8"></a>Атрибуты архивной проверки

### 10.8.1 <a name="10.8.1"></a>Атрибут `TimeStampValidationData`
...
### 10.8.2 <a name="10.8.2"></a>Атрибут `ArchiveTimeStamp`
...
### 10.8.3 <a name="10.8.3"></a>Атрибут `RenewedDigests`
...
заданной в [[5]](#99.5), подпункт 4.4.3.2. Если невозможно
...
## 10.9 <a name="10.9"></a>Требования по реализации РЭЦП формата XAdES

В этом подразделе определяются дополнительные требования к подписи XAdES.
Требования относятся ко всем базовым профилям.

Помимо атрибутов, указанных в разделе [7](#7), РЭЦП ДОЛЖНА содержать
следующие элементы:
...
# 11 <a name="11"></a>Формат PAdES

## 11.1 <a name="11.1"></a>Общие положения

PDF, переносимый формат данных, определен базовой спецификацией
[[18]](#99.18). PDF описывает структуру цифровых документов, которые
...
вложенной. Формат подписи описывается в [11.2](#11.2). PAdES расширяет данный
формат и налагает на него ряд ограничений. Расширения и уточнения PAdES
описываются в [11.3](#11.3), [11.4](#11.4).

## 11.2 <a name="11.2"></a>Электронная цифровая подпись PDF

### 11.2.1 <a name="11.2.1"></a>Словарь `Sig`
...
набора октетов описаны в [11.2.2](#11.2.2).
...
|-------------|------|-----------|-----------|
| Type        | name | Опц.      | `"Sig"`      |
| Filter      | name | Обяз.     | Идентификатор обработчика подписи (см. [11.2.3](#11.2.3)) |
...
содержится в [[18]](#99.18). 

### 11.2.2 <a name="11.2.2"></a>Задание подписываемых данных
...
### 11.2.3 <a name="11.2.3"></a>Обработчик подписи
...
согласно требованиям [[18]](#99.18) (приложение E). Идентификатор может
...
### 11.2.4 <a name="11.2.4"></a>Кодировка подписи PDF
...
## 11.3 <a name="11.3"></a>PAdES на основе CAdES

### 11.3.1 <a name="11.3.1"></a>Основные положения
...
### 11.3.2 <a name="11.3.2"></a>Кодировка CAdES
...
контрподписями используется другой механизм, описанный в [11.3.4](#11.3.4).

### 11.3.3 <a name="11.3.3"></a>Ограничения на `ByteRange`
...
### 11.3.4 <a name="11.3.4"></a>Контрподписи
...
### 11.3.5 <a name="11.3.5"></a>Дополнительные объекты для долгосрочных подписей

### 11.3.5.1 <a name="11.3.5.1"></a>Расширения
...
(см. [11.3.1](#11.3.1)) СЛЕДУЕТ добавить следующий элемент:
...
#### 11.3.5.2 <a name="11.3.5.2"></a>Расширение DSS
...
(см. [11.4](#11.4)), к встречающимся в документе штампам времени.
...
#### 11.3.5.3 <a name="11.3.5.3"></a>Расширение DTS
...
## 11.4 <a name="11.4"></a>PAdES для XML-вставок
...
расширения DSS и DTS, описанные в [11.3.5](#11.3.5). Тогда объекты этих
расширений ДОЛЖНЫ включать аттестаты для подписей XAdES.


# <a name="91"></a>Приложение A (рекомендуемое). Расширенные профили

## A.1 <a name="91.1"></a>Общие положения
...
двумя способами, описанными в разделе [10](#10) (прямое и непрямое
включения).
...
## A.2 <a name="91.2"></a>Профили, не допускающие ссылки на аттестаты проверки

### A.2.1 <a name="91.2.1"></a>Профили E-BES и E-EPES
...
### A.2.2 <a name="91.2.2"></a>Профиль E-T

Профиль E-T является аналогом профиля B-T.

### A.2.3 <a name="91.2.3"></a>Профиль E-A типа 1

Профиль E-A типа 1 является аналогом профиля B-LTA.

## A.3 <a name="91.3"></a>Профили, допускающие ссылки на аттестаты проверки

### A.3.1 <a name="91.3.1"></a>Профиль E-С
...
### A.3.2 <a name="91.3.2"></a>Профиль E-X
...
### A.3.3 <a name="91.3.3"></a>Профиль E-X-Long
...
### A.3.4 <a name="91.3.4"></a>Профиль E-X-L
...
#### A.3.5 <a name="91.3.5"></a>Профиль E-A типа 2
