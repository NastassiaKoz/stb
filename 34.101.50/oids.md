...
### [4 Общие положения](#4)
#### [4.1 Назначение](#4.1)
#### [4.2 Идентификаторы объектов](#4.2)
### [5 Дерево идентификаторов](#5)
### [6 Регистрация](#6)  
#### [6.1 Методы регистрации](#6.1)
#### [6.2 Назначение идентификаторов в настоящем стандарте](#6.2)
#### [6.3 Назначение идентификаторов в ТНПА](#6.3)
#### [6.4 Назначение идентификаторов регистрирующей организацией](#6.4)
### [Приложение А (рекомендуемое) Идентификаторы регистрирующих организаций](#91)
### [Приложение Б (рекомендуемое) Идентификаторы объектов для алгоритмов СТБ 1176.1](#92)
### [Приложение В (рекомендуемое) Идентификаторы объектов для алгоритмов СТБ 1176.2](#93)
### [Приложение Г (рекомендуемое) Идентификаторы объектов для алгоритмов ГОСТ 28147](#94)
### [Приложение Д (рекомендуемое) Идентификаторы объектов Государственной системы управления открытыми ключами](#95)
### [Приложение Е (рекомендуемое) Защита XML-документов с помощью алгоритмов СТБ 34.101.31, СТБ 34.101.45, СТБ 34.101.47 и СТБ 34.101.77](#96)
### [Библиография](#99)
...
## 4.2 <a name="4.2"></a>Идентификаторы объектов
...
## 6.1 <a name="6.1"></a>Методы регистрации
...
## 6.2 <a name="6.2"></a>Назначение идентификаторов в настоящем стандарте
...
## 6.3 <a name="6.3"></a>Назначение идентификаторов в ТНПА
...
## 6.4 <a name="6.4"></a>Назначение идентификаторов регистрирующей организацией
...
# <a name="91"></a>Приложение А (рекомендуемое)
...
# <a name="92"></a>Приложение Б (рекомендуемое)
...
# <a name="94"></a>Приложение Г (рекомендуемое)
...
# <a name="95"></a>Приложение Д (рекомендуемое)
...
# <a name="96"></a>Приложение Е (рекомендуемое)
...
[3] <a name="99.3"></a>  Eastlake D., Reagle J., Solo D., Hirsch F., 
...
[4] <a name="99.4"></a>  Eastlake D., Reagle J., Solo D., Hirsch F., 
...
[5] <a name="99.5"></a>  Eastlake D., Reagle J., Imamura T., Dillaway 
...
[6] <a name="99.6"></a>  Eastlake D., Reagle J., Hirsch F., Roessler 
