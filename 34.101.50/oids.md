...
выбираться так, чтобы был обеспечен заданный в таблице [В.1](#tab1) паритет между 
уровнем стойкости СТБ 1176.2 и порядком стойкости ПФОК. 

**Таблица В.1 <a name="tab1"></a> – Паритет между уровнем стойкости СТБ 1176.2 и порядком стойкости ПФОК**
...
В таблице [В.2](#tab2) определены стандартные долговременные параметры СТБ 1176.2, 
...
В таблице [В.3](#tab3) определены стандартные параметры ПФОК, полученные с помощью 
...
Числа *p*, *q*, *a*, *g* в таблицах [В.2](#tab2) и [В.3](#tab3) записаны в шестнадцатеричной 
...
**Таблица В.2 <a name="tab2"></a> – Стандартные долговременные параметры СТБ 1176.2**
...
**Таблица В.3 <a name="tab3"></a> – Стандартные долговременные параметры ПФОК**
...
ГОСТ 28147, (пункт 1.2). В таблице [Г.1](#tabg1) определен стандартный блок 
...
**Таблица Г.1 <a name="tabg1"></a> – Стандартный блок подстановки ГОСТ 28147**
