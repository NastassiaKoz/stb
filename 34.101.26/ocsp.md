...
### [3 Термины и определения, обозначения](#3)
### [4 Сокращения](#4)
### [5 Общие положения](#5)
### [6 Онлайновый протокол проверки статуса сертификата](#6)
### [Приложение А (справочное) Ключевые слова](#91)
### [Приложение Б (обязательное) Модуль AСН.1](#92)
### [Приложение В (обязательное) Отличительные правила кодирования](#93)
...
## <a name="5.6"></a>5.6 Предварительное создание ответа
...
## <a name="5.7"></a>5.7 Делегирование полномочий подписи онлайнового протокола проверки статуса сертификата
...
## <a name="5.8"></a>5.8 Компрометация ключа удостоверяющего центра 
...
## <a name="5.10"></a>5.10 Функциональные требования

### <a name="5.10.1"></a>5.10.1 Содержание сертификата
...
### <a name="5.10.2"></a>5.10.2 Требования по приему ответа
...
## <a name="5.11"></a>5.11 Аспекты безопасности
...
# 6 <a name="6"></a>Онлайновый протокол проверки статуса сертификата

## <a name="6.1"></a>6.1 Запрос

### <a name="6.1.1"></a>6.1.1 Синтаксис запроса
...
использоваться отличительные правила (см. приложение [В](#93)).
...
отличительные правила (см. приложение [В](#93));
...
### <a name="6.1.2"></a>6.1.2 Примечания по запросу
...
критические. В [6.3](#6.3) определяется несколько расширений. Другие
...
## <a name="6.2"></a>6.2 Ответ

### <a name="6.2.1"></a>6.2.1 Синтаксис ответа
...
использованием отличительных правил кодирования (см. приложение [В](#93)).
...
использоваться отличительные правила (см. приложение [В](#93)). В качестве 
алгоритма хэширования ДОЛЖЕН использоваться алгоритм, определенный в запросе.

`producedAt` – время создания ответа (см. [5.5](#5.5)), представлено 
...
- `certID` – определен в [6.1.1](#6.1.1);
- `certStatus` – статус сертификата, определенный типом `CertStatus`. Значения
компонентов типа `CertStatus` описаны в [5.3](#5.3);
...
`nextUpdate` также не задан (см. [5.5](#5.5));
...
### <a name="6.2.2"></a>6.2.2 Примечания по ответу
...
### <a name="6.3.1"></a>6.3.1 Привязка запроса к ответу
...
на повторе ответов (см. [5.11](#5.11)). Расширение включается в запросы как
...
### <a name="6.3.2"></a>6.3.2 Ссылки на список отозванных сертификатов
...
### <a name="6.3.3"></a>6.3.3 Принимаемые типы ответов
...
Как отмечено в [6.2.1](#6.2.1), OCSP серверы ДОЛЖНЫ быть способны выдавать 
...
### <a name="6.3.4"></a>6.3.4 Архивное хранение
...
### <a name="6.3.5"></a>6.3.5 Расширения записей списка отозванных сертификатов
...
### <a name="6.3.6"></a>6.3.6 Переадресация
...
# <a name="91"></a>Приложение А (справочное)
...
# <a name="92"></a>Приложение Б (обязательное)
...
# <a name="93"></a>Приложение В (обязательное)
